...
export default function HomePage() {
  ...
  return (
    <div className="mx-auto mt-24 max-w-md text-center">
      ...
      <h1 className="mt-4 text-2xl font-semibold text-slate-900 dark:text-slate-100">Puma DMS</h1>
      <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
        Document Management System — Puma Energy Pakistan
      </p>
      <a
        href={loginUrl()}
        className="mt-8 inline-block rounded-md bg-slate-900 px-6 py-3 text-sm font-medium text-white hover:bg-slate-700 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-slate-300"
      >
